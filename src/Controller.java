...
public class Controller {
      ...
      while (true) {
        ...
        new Thread(() -> {
          ...
          try {
            ...
            System.err.println("Error in creating buffered reader " + client.getPort());
            e.printStackTrace();
          }
        }).start();
      }
    } catch (IOException e) {
      System.out.println("Error setting up server socket in controller");
      e.printStackTrace();
    }
  }
  ...
  private void send(String message, Socket socket) {
    ...
    try {
      ...
      System.out.println("Error in creating Printwritter for the message " + message);
    }
